    ...
    <div class="container"> 
        ...
        <aside>
            ...
            <div class="sidebar" id="sidebar">
                ...
                <a href="booking_dashboard.jsp" class="active">
...
%>
                ...
                <tr>
                    ...
                    <td><%= date %> / <%= time %></td>
                    <td>
                        <a href="booking_details.jsp?booking_id=<%= booking_id %>" style="background-color:blue;padding: 5px 5px; color: white;">Details</a>
                    </td>
                    <td>
