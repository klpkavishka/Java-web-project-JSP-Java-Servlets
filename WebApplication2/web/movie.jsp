...
<body>
            ...
            <div class="form-container table-container">
                ...
                <div class="table">
                    <div class="table-header">
                        ...
                        <a href="add_movie.jsp">
                            <input class="submit" type="button" name="submit" value="Add Movie">
                        </a>
                    </div>
    ...
    <%
               ...
               // Connect to Database
                ...
                while(result.next()){
                int mid = result.getInt("movie_id");
...
%>
                ...
                <tr>
                    ...
                    <td>
                       <img src="<%= request.getContextPath() + "/"+image %>" alt="Movie Image" style="width: 100px; height: auto;">
                    </td>

                    <td><%= date %></td>
                    <td><%= time %></td>
                    <td>
                        <a href="update_movie.jsp?movie_id=<%= mid %>"><span class="material-icons-sharp edit">edit</span></a>
                        <a href="movie_delete.jsp?movie_id=<%= mid %>"> <span class="material-icons-sharp delete">delete</span></a>
                    </td>
                </tr>
<%
                   }
