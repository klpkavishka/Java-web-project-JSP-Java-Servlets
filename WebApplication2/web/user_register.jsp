...
<body>
        ...
        <div class="login-container">
          <form action="user_registerServlet" method="POST" id="loginForm" class="login-form">
          ...
          <br>
            <div class="form-group">
              ...
              <input type="text" id="username" name="fname" placeholder="Enter first name" required>
            </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="email" id="username" name="mail" placeholder="Enter email" required>
            </div>
            <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="number" id="password" name="info" placeholder="Enter phone number" required>
            </div>
            <div class="login-info">
