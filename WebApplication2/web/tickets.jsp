            ...
            <div class="form-container table-container">
                ...
                <div class="table">
                    <div class="table-header">
                        ...
                        <a href="add_ticket.jsp">
                            <input class="submit" type="button" name="submit" value="Add Tickets">
                        </a>
                    </div>
...
%>
                ...
                <tr>
                    ...
                    <td><%= price %></td>
                    <td>
                        <a href="update_ticket.jsp?ticket_id=<%= tid %>"><span class="material-icons-sharp edit">edit</span></a>
                        <a href="ticket_delete.jsp?ticket_id=<%= tid %>"> <span class="material-icons-sharp delete">delete</span></a>
                    </td>
                </tr>
<%
                   }
