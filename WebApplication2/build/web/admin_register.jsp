...
<body>
        ...
        <div class="login-container">
          <form action="admin_registerServlet" method="POST" id="loginForm" class="login-form">
          ...
          <br>
            <div class="form-group">
              ...
              <input type="text" id="username" name="fname" placeholder="Enter Username" required>
            </div>
          <div class="form-group">
              <label for="username">Last Name:</label>
              <input type="text" id="username" name="lname" placeholder="Enter Username" required>
            </div>
          <div class="form-group">
              <label for="username">E Mail:</label>
              <input type="email" id="username" name="mail" placeholder="Enter Username" required>
            </div>
            <div class="form-group">
