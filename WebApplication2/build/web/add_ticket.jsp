    ...
    <div class="container"> 
        ...
        <aside>
            ...
            <div class="sidebar" id="sidebar">
                ...
                <a href="add_ticket.jsp"class="active">
                    <span class="material-icons-sharp">queue</span>
            ...
            <div class="form-container">
                ...
                <form action="addTicketsServlet" method="POST" >
                    <div class="row">
                        <div class="column">
                            <label for="title">Ticket Name</label>
                            <input type="text" name="type" id="title" placeholder="Type of tickets">
                        </div>
                     ...
                     <div class="row">
                        <div class="column">
                            ...
                            <input type="number" name="price" id="title" placeholder="">
                        </div>
                   ...
                   <div class="row">
                    <div class="column">
                        ...
                        <input class="submit" type="submit" name="submit" value="Add Ticket">
                    </div>
                   </div>
                </form>
