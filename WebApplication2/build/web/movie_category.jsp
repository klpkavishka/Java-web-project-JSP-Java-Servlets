    ...
    <div class="container"> 
        ...
        <aside>
            ...
            <div class="sidebar" id="sidebar">
                ...
                <a href="movie_category.jsp" class="active">
...
%>
                ...
                <tr>
                    ...
                    <td><%= description %></td>
                    <td>
                        <a href="update_category.jsp?category_id=<%= cid %>"><span class="material-icons-sharp edit">edit</span></a>
                        <a href="category_delete.jsp?category_id=<%= cid %>"> <span class="material-icons-sharp delete">delete</span></a>
                    </td>
                </tr>
<%
                   }
