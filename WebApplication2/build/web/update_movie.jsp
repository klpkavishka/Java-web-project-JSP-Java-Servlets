        ...
        <aside>
            ...
            <div class="sidebar" id="sidebar">
                ...
                <a href="add_movie.jsp">
                    <span class="material-icons-sharp"class="active">add</span>
                    <h3>Add Movie</h3>
                </a>
...
<%
               ...
               // Connect to Database
                ...
                String imdb = result1.getString("imdb");
                String trailer = result1.getString("trailer");
                int duration = result1.getInt("duration");
                int release_date = result1.getInt("release_date");
...
%>
            ...
            <div class="form-container">
                ...
                <form action="update_movieServlet?movie_id=<%= movie_id %>" method="POST" enctype="multipart/form-data">
                     <div class="row">
                        <div class="column">
                            <label for="title">Movie Name</label>
                            <input type="text" name="name" id="title" placeholder="Product Title" required value="<%= name %>">
                        </div>
                        
                        <div class="column">
                            <label for="sub-title">Movie Title</label>
                            <input type="text" name="title" id="sub-title" placeholder="Product sub title"required value="<%= title %>">
                        </div>  
                    </div>
                     ...
                     <div class="row">
                        <div class="column">
                            ...
                            <input type="number" name="release" id="title" placeholder="Product Title" required value="<%= release_date %>">
                        </div> 
                       <div class="column">
                            <label for="discount">IMDB</label>
                            <input type="text" name="imdb"  min="0"  id="discount" placeholder="Discount Price"required value="<%= imdb %>">
                        </div>  
                    </div>
                   ...
                   <div class="row">
                        <div class="column">
                            ...
                            <input type="text" name="location"  min="0"  id="discount" placeholder="Discount Price"required value="<%= location %>">
                        </div>  
                       <div class="column">
                            <label for="discount">Duration (minute)</label>
                            <input type="number" name="duration"  min="0"  id="discount" placeholder="Discount Price"required value="<%= duration %>">
                        </div>  
                    </div>
                    ...
                    <div class="row">
                        <div class="column">
                            ...
                            <input type="text" name="time"  min="0" id="price" placeholder="Product Price" required value="<%= time %>">
                        </div>

                        <div class="column">
                            <label for="discount">Date</label>
                            <input type="text" name="date"  min="0"  id="discount" placeholder="Discount Price"required value="<%= date %>">
                        </div>  
                    </div>
                    ...
                    <div class="column">
                            ...
                            <input type="text" name="trailer"  min="0"  id="discount" placeholder="Discount Price"required value="<%= trailer %>">
                        </div>  
                    </div>
<%
                   }
            ...
            %>   
                   ...
                   <div class="row">
                    <div class="column">
                        ...
                        <input class="submit" type="submit" name="submit" value="Update Movie">
